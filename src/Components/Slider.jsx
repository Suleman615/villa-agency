...
// },[])
    ...
    return (
        <>
            ...
            <div className=" ">
                <div className="w-screen-lg h-[120vh]  mx-auto relative">
                    {firstImage && <div className='absolute  h-full w-full '>
                         <img className='h-full w-full object-cover absolute -z-10' src={image1} alt=""/>
<div className='px-16  md:px-28 mt-40 md:mt-64  mx-auto lg:mx-40 w-fit   '>
    <p className='bg-white w-fit px-4 py-1 text-lg font-semibold'>Sukkur, <span className='text-orange-600'>Pakistan</span></p>
    <h1 className='text-white font-bold text-6xl md:text-8xl lg:text-6xl mt-10'>HURRY!</h1>
    <h1 className='text-white font-bold text-6xl md:text-8xl lg:text-6xl w-auto md:w-96 leading-snug'> GET THE BEST VILLA FOR YOU</h1>
</div>
                    </div>}
                    { secondImage && <div className='absolute  h-full w-full '>

                            <img className='h-full w-full object-cover absolute -z-10' src={image2} alt=""/>
                        <div className='px-16 md:px-28 w-fit mx-auto mt-40 lg:mx-40 md:mt-64 '>
                            <p className='bg-white w-fit px-4 py-1 text-lg font-semibold'>Islamabad, <span className='text-orange-600'>Pakistan</span></p>
                            <h1 className='text-white font-bold text-6xl md:text-8xl lg:text-6xl mt-10'>BE QUICK!</h1>
                            <h1 className='text-white font-bold text-6xl md:text-8xl lg:text-6xl w-auto md:w-96 leading-snug'> GET THE BEST VILLA IN TOWN</h1>
                        </div>
                    </div>}
                    {thirdImage && <div className='absolute  h-full w-full '>
                         <img className='h-full w-full object-cover absolute -z-10' src={image3} alt=""/>
                        <div className='px-16 md:px-28 mx-auto mt-40 md:mt-64 lg:mx-40 w-fit   '>
                            <p className='bg-white w-fit  px-4 py-1 text-lg font-semibold'>Quetta, <span className='text-orange-600'>Pakistan</span></p>
                            <h1 className='text-white font-bold text-6xl md:text-8xl lg:text-6xl mt-10'>ACT NOW!</h1>
                            <h1 className='text-white font-bold text-6xl md:text-8xl lg:text-6xl w-auto md:w-96 leading-snug'> GET THE HIGHEST LEVEL PENTHOUSE</h1>
                        </div>
                    </div>}
